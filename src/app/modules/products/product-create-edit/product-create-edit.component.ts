...
export class ProductCreateEditComponent implements OnInit {
 ...
 public rows = [
  { id: '1001', productName: 'Intel Core i5-11400 Processor', categoryName: 'Processor', price: '16000', quantity:'10', availability: 'instock', company:'Intel', modelNumber: '‎BX8070811400', warranty: '3 Year', desc:' Complete Specification'},
